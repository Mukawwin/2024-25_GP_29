...
//هذا التابع هو مثيل للتابع في الاعلى لكنه يبحث عن طريق الاسم ايضا
  Future<bool> checkAllergies(String name) async {
    DatabaseService databaseService = DatabaseService();
    List data = await databaseService.getAllergies(name);
    return data.isNotEmpty;
  }
