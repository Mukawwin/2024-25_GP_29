...
import 'package:mukawwin_3/models/alert.dart';
...
List<Alert> allalert = [
  Alert(
    ...
    desc: 'The Product has no allergies for you. safe to consume!',
  ...
  Alert(
    ...
    color: Colors.yellow,
    desc:
        "We couldn't ingredients. Please retake the picture and ensure the text is clear for accurate result",
